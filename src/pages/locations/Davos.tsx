...
const Davos = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Corporate Videographer in Davos | Toba Oduwaiye</title>
        <meta name="description" content="Expert corporate videography in Davos. Specializing in WEF coverage, high-level interviews, and conference filming." />
      ...
      <div className="bg-[#051126] text-white min-h-screen selection:bg-teal-accent selection:text-[#051126]">
        ...
        <section className="pt-32 pb-16 px-6 max-w-7xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-display font-bold mb-6">
            Corporate Videographer in <span className="text-teal-accent">Davos</span>
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-24">
            ...
            <div className="bg-gray-800 rounded-sm overflow-hidden aspect-video relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-teal-accent font-display font-bold text-2xl">DAVOS PRODUCTION</span>
              </div>
            </div>
          </div>
        </section>
